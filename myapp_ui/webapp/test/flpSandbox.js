		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commyuiappmyappui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commyuiappmyappui-display": {
								"semanticObject": "commyuiappmyappui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.my.uiapp.myappui",
									"url": sap.ui.require.toUrl("com/my/uiapp/myappui")
								}
							}
						}
					}
